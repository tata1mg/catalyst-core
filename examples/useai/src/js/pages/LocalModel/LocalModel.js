    ...
    return (
        <div className="max-w-[1040px] mx-auto px-10 py-12 animate-[fadeIn_0.4s_ease-out]">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                <div>
                    <div className="font-mono text-[13px] text-indigo-400 mb-2">05 / Local Model</div>
                    <h1 className="text-4xl font-semibold tracking-tight text-white mb-2">
                        Your data never leaves.
                    </h1>
                    <p className="text-neutral-400 max-w-[54ch] leading-relaxed text-sm">
                        Same prompt, same output. Flip to local and inference runs in the browser — then cut
                        the network and watch which one survives.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {/* Cloud card */}
                <div
                    className={`bg-[#10131D] border rounded-2xl p-5.5 shadow-2xl transition duration-300 ${cloudBorder}`}
                >
                    ...
                    <p className="text-[12.5px] leading-relaxed text-neutral-400">{cloudNote}</p>
                </div>

                {/* Local card */}
                <div
                    className={`bg-[#10131D] border rounded-2xl p-5.5 shadow-2xl transition duration-300 ${localBorder}`}
                >
                    <div className="flex justify-between items-center mb-4.5">
                        <span className="text-[13.5px] font-semibold text-white/90 flex items-center gap-2">
                    ...
                    <div className="h-[1px] bg-white/5 my-4" />
                    <p className="text-[12.5px] leading-relaxed text-neutral-400">{localNote}</p>
                </div>
            </div>
