...
…342 more tokens`
    ...
    return (
        <div className="max-w-[1120px] mx-auto px-10 py-12 animate-[fadeIn_0.4s_ease-out]">
            {/* Page Header */}
            <div className="mb-8">
                <div className="font-mono text-[13px] text-indigo-400 mb-2">04 / Multi-model Pipeline</div>
                <h1 className="text-4xl font-semibold tracking-tight text-white mb-2">
                    Pay for what you need.
                </h1>
                <p className="text-neutral-400 max-w-[62ch] leading-relaxed text-sm">
                    Route the cheap, fast model at the noise; spend the smart model only on what matters. One{" "}
                    <code className="font-mono text-white bg-white/5 px-1 py-0.5 rounded text-[0.9em]">
                        useAI
                    </code>{" "}
                    pipeline, two stages, a fraction of the cost.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[180px_1fr_1fr] border border-white/5 rounded-2xl overflow-hidden bg-[#10131D] shadow-2xl mb-1 select-none">
                ...
                <div className="p-6 border-r border-white/5 flex flex-col justify-between min-h-[220px]">
                    ...
                    <div className="flex gap-6 mt-auto">
                        <div>
                            <div className="font-mono text-[9px] text-neutral-500 uppercase font-semibold mb-1">
                                time
                            </div>
                        ...
                        <div>
                            ...
                            <div className="font-mono text-[17px] font-semibold text-neutral-300">
                                $0.0002
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-6 flex flex-col justify-between min-h-[220px]">
                    <div>
                        ...
                        <p className="text-[13px] text-neutral-400 leading-relaxed mb-6">
                            Explains clinical significance on the 6 values that were flagged. Reasoning only
                            where it pays off.
                        </p>
                    </div>
