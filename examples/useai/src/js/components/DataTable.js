                        ...
                        <tr className="bg-[var(--surface-2)] border-b border-[var(--border)]">
                            {headers &&
                                headers.map((header, idx) => (
                                    <th
                                        key={idx}
                                        className="px-4 py-2 font-semibold text-white border-r border-[var(--border)] last:border-r-0"
                                    >
                                        {header}
                                    </th>
                                ))}
                                ...
                                >
                                    {row &&
                                        row.map((cell, cIdx) => (
                                            <td
                                                key={cIdx}
                                                className="px-4 py-2 text-neutral-300 border-r border-[var(--border)] last:border-r-0"
                                            >
                                                {cell}
                                            </td>
                                        ))}
