...
export default function AttachmentRenderer({ url }) {
    ...
    if (loading) {
        return <div className="w-full h-[80px] bg-neutral-800 animate-pulse rounded-xl my-2" />
    }

    if (error) {
        return <div className="text-red-500 text-[11px] my-1 font-sans">attachment unavailable</div>
    }
