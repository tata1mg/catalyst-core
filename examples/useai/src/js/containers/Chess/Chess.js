    ...
    w: {
        p: (
            <svg viewBox="0 0 45 45" className="w-[85%] h-[85%] select-none">
                <path
                    d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-.83.33-1.41 1.15-1.41 2.1 0 1.25 1.01 2.27 2.27 2.27H25.7c1.26 0 2.27-1.02 2.27-2.27 0-.95-.58-1.77-1.41-2.1 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z"
                    fill="#fff"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
        ...
        b: (
            <svg viewBox="0 0 45 45" className="w-[85%] h-[85%] select-none">
                <path
                    d="M 9,36 C 9,36 22.5,37 22.5,29 C 22.5,29 20,24 20,20 C 20,15 22.5,10 22.5,10 C 22.5,10 25,15 25,20 C 25,24 22.5,29 22.5,29 C 22.5,37 36,36 36,36 C 36,36 33.5,39 22.5,39 C 11.5,39 9,36 9,36 z"
                    fill="#fff"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                ...
                <path
                    d="M 17.5,18 L 27.5,18 M 22.5,14 L 22.5,22"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                />
        ...
        r: (
            <svg viewBox="0 0 45 45" className="w-[85%] h-[85%] select-none">
                <path
                    d="M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z M 12,36 L 33,36 L 30,15 L 15,15 L 12,36 z M 13,15 L 32,15 L 35,9 L 31,9 L 31,12 L 27,12 L 27,9 L 18,9 L 18,12 L 14,12 L 14,9 L 10,9 L 13,15 z"
                    fill="#fff"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
        ...
        q: (
            <svg viewBox="0 0 45 45" className="w-[85%] h-[85%] select-none">
                <path
                    d="M 9 26 C 17.5 24.5 22.5 13 22.5 13 C 22.5 13 27.5 24.5 36 26 C 33 28 31 32.5 31 35.5 L 14 35.5 C 14 32.5 12 28 9 26 z"
                    fill="#fff"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                ...
                <path
                    d="M 9,26 L 22.5,9 L 36,26 M 9,26 L 22.5,7.5 L 36,26"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                />
        ...
        k: (
            <svg viewBox="0 0 45 45" className="w-[85%] h-[85%] select-none">
                <path
                    d="M 22.5,11.63 L 22.5,6 M 20,8 L 25,8 M 22.5,11.63 C 22.5,11.63 26.5,8 29.5,12 C 32.5,16 28.5,28.5 28.5,28.5 L 16.5,28.5 C 16.5,28.5 12.5,16 15.5,12 C 18.5,8 22.5,11.63 22.5,11.63 z"
                    fill="#fff"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                />
                <path
                    d="M 11.5,30 C 11.5,30 22.5,31 22.5,25.5 C 22.5,31 33.5,30 33.5,30 C 33.5,30 31,33 22.5,33 C 14,33 11.5,30 11.5,30 z"
                    fill="#fff"
                    stroke="#000"
                    strokeWidth="1.5"
                    strokeLinecap="round"
...
export default function Chess() {
    ...
    const useAIResult = useAI({
        ...
        systemPrompt:
            "You are a chess engine playing as Black. Return only the selected move in SAN notation.",
    })
...
IMPORTANT: Respond with ONLY the selected SAN move (e.g. "Nf6", "exd5", "O-O") exactly as it appears in the list. Do not include extra text, explanations, markdown or brackets. Just the move.`
    ...
    useEffect(() => {
        if (aiThinking && !loading && !error && chessRef.current) {
            ...
            const matchedMove = validMoves.find((m) => m.toLowerCase() === cleanOutput.toLowerCase())
                ...
                rendered.push(
                    <div
                        ...
                        className={`relative aspect-square flex items-center justify-center cursor-pointer select-none transition-all duration-200 ${
                            ...
                            isCheck
                                ? "bg-red-500/25 ring-2 ring-red-500 z-10 shadow-[0_0_15px_rgba(239,68,68,0.4)]"
                                : ""
                        }`}
                    >
                        {/* Piece Icon */}
    ...
    const renderMoveList = () => {
        ...
        for (let i = 0; i < history.length; i += 2) {
            ...
            rows.push(
                <div
                    key={moveNum}
                    className="flex border-b border-[var(--border)] py-1.5 text-[12.5px] font-mono"
                >
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-12 animate-[fadeIn_0.5s_ease-out]">
            ...
            <div className="text-center md:text-left mb-8">
                ...
                <p className="text-[14px] leading-relaxed text-[var(--text-2)] max-w-[60ch]">
                    Play Chess against a cloud AI opponent. Choose your engine provider to see how they
                    perform in complex chess logic and positional strategy.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-4 flex flex-col gap-6 order-2 lg:order-1">
                    ...
                    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 shadow-xl flex flex-col h-[320px]">
                        <h2 className="text-[13px] tracking-wider uppercase text-[var(--text-3)] font-bold mb-3 font-mono">
                            Match Move Log
                        </h2>
                        <div className="flex-1 overflow-y-auto pr-1 border border-[var(--border)] rounded-xl p-3 bg-[var(--surface-2)]/40">
                            {history.length === 0 ? (
                                <div className="text-[12px] text-[var(--text-3)] italic text-center py-10 font-mono select-none">
                                    No moves played yet
                                </div>
                            ) : (
                                <div>
                                ...
                                >
                                    ...
                                    {gameStatus === "draw" && (
                                        <>
                                            ...
                                            <p className="text-[13px] text-[var(--text-2)] mb-5">
                                                Match ended in a tie/stalemate.
                                            </p>
                                        </>
                                    )}
