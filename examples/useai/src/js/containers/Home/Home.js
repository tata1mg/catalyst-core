...
export default function Home() {
    ...
    const labsMobile = [
        {
            ...
            unit: "ng/mL",
            flag: "LOW",
            flagBg: "bg-amber-500/10 border-amber-500/20",
        ...
        },
        {
            ...
            unit: "%",
            flag: "HIGH",
            flagBg: "bg-red-500/10 border-red-500/20",
    ...
    const deltaCardsMobile = [
        ...
        ...c,
        dot: c.done ? (ch03ModeMobile === "local" ? "bg-teal-400" : "bg-indigo-400") : "bg-neutral-600",
    }))
        ...
        return (
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-[18px] pb-6 relative">
                    ...
                    {chapter === "overview" && (
                        <div className="py-2.5 animate-[fadeIn_0.3s_ease]">
                            ...
                            <p className="text-[14px] leading-relaxed text-neutral-400 mb-6.5">
                                One React codebase, native on every platform. One hook for cloud, on-device
                                and in-browser inference. Tap a chapter below.
                            </p>
                            <button
                                onClick={startCh1}
                            ...
                            <div className="flex flex-col gap-2.5 mb-5 select-none">
                                <div className="bg-red-500/[0.07] border border-red-500/25 rounded-xl p-3.5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-mono text-[17px] font-bold text-red-400">
                                            64
                                        </span>
                                    </div>
                                ...
                                <div className="bg-[var(--accent-dim)] border border-[var(--accent-line)] rounded-xl p-3.5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-mono text-[17px] font-bold text-indigo-300">
                                            15
                                        </span>
                                    </div>
                                    <div className="h-1.5 rounded-full bg-[var(--surface-3)] mt-2.5">
                                ...
                                {labsMobile.map((card, idx) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span
                                                className={`font-mono text-[9px] font-semibold px-2 py-0.5 border rounded-md ${card.flagBg} ${card.flagColor}`}
                                            >
                                                {card.flag}
                                            </span>
                                        </div>
                                        <div className="flex items-baseline gap-1.5">
                                            <span
                                                className={`text-[21px] font-semibold font-mono ${card.flagColor}`}
                                            >
                                                {card.value}
                                            </span>
                    ...
                    {chapter === "02" && (
                        <div
                            className={`absolute inset-0 flex flex-col bg-gradient-to-b from-[#1a1d27] to-[#07080c] select-none ${
                            ...
                            <div className="mx-4 mb-2 bg-[var(--bg-2)] border border-white/10 rounded-xl p-3 shadow-xl shrink-0">
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="text-right">
                                        <div className="font-mono text-lg font-semibold text-amber-400 leading-none">
                                            112
                                        </div>
                    ...
                    {chapter === "03" && (
                        <div className="py-2 animate-[fadeIn_0.3s_ease]">
                            <div className="font-mono text-[11px] text-indigo-400 mb-1.5">03 / Delta</div>
                            <h1 className="text-2xl font-semibold leading-tight tracking-tight text-white mb-4.5">
                                Not faster.
                                <br />
                                Different.
                            ...
                            <div className="grid grid-cols-2 gap-2.5">
                                {deltaCardsMobile.map((c, idx) => (
                                    ...
                                    >
                                        ...
                                        {c.done ? (
                                            <div>
                                                <div className={`font-mono text-[17px] font-bold ${c.color}`}>
                                                    {c.value}
                                                </div>
                            ...
                            <div className="flex flex-col gap-0 items-center">
                                ...
                                <div className="w-full bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-4">
                                    <div className="flex items-center gap-1.5 mb-2">
                                        ...
                                        <span className="ml-auto font-mono text-[9.5px] text-neutral-500 font-bold uppercase tracking-wider">
                                            fast
                                        </span>
                                    </div>
                                    <div className="flex gap-4">
                                        <span className="font-mono text-[14.5px] font-semibold text-indigo-300">
                                            ~80ms
                                        </span>
                                        <span className="font-mono text-[14.5px] font-semibold text-neutral-400">
                                            $0.0002
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="w-full bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-4">
                                    ...
                                    <div className="flex gap-4">
                                        <span className="font-mono text-[14.5px] font-semibold text-teal-400">
                                            ~900ms
                                        </span>
                                        <span className="font-mono text-[14.5px] font-semibold text-neutral-400">
                                            $0.0040
                    ...
                    {chapter === "05" && (
                        <div className="py-2 animate-[fadeIn_0.3s_ease]">
                            ...
                            <div className="flex flex-col gap-2.5">
                                <div
                                    className={`bg-[var(--surface)] border rounded-xl p-4 shadow transition ${
                                ...
                                >
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <span
                                            className={`font-mono text-[10px] font-semibold ${ch05SourceMobile === "cloud" ? "text-indigo-400" : "text-red-400"}`}
                                        >
                                            {ch05SourceMobile === "cloud" ? "streaming" : "network lost"}
                                        </span>
                                    </div>
                                    <div
                                        className={`font-mono text-2xl font-semibold leading-none ${ch05SourceMobile === "cloud" ? "text-indigo-300" : "text-red-400"}`}
                                    >
                                ...
                                >
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <span className="font-mono text-[10px] font-semibold text-teal-400 uppercase tracking-wider">
                                            🔒 device
                                        </span>
                                    </div>
                        ...
                        <div className="py-2 animate-[fadeIn_0.3s_ease]">
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-3 select-none">
                                ...
                                <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-3 shadow-sm">
                                    ...
                                    <div className="text-[10px] text-neutral-500 font-semibold uppercase tracking-wider font-mono">
                                        local
                                    </div>
                                </div>
                                <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-3 shadow-sm">
    ...
    if (isMobileScreen) {
        return (
            <div className="flex flex-col min-h-screen bg-[var(--bg)] text-[var(--text)] transition-colors duration-250 font-sans relative">
                ...
                {/* Mobile Scroll Area */}
                <div className="flex-grow min-h-0 relative flex flex-col">{renderMobileViewport(false)}</div>
        ...
        <div className="flex min-h-screen bg-[var(--bg)] text-[var(--text)] transition-colors duration-250 select-none font-sans">
            ...
            <aside className="w-72 shrink-0 sticky top-0 self-start h-screen bg-[var(--bg-2)] border-r border-[var(--border)] flex flex-col p-6.5">
                ...
                <div className="flex items-center gap-3 pb-5.5 border-b border-[var(--border)] mb-6">
                    ...
                    <div>
                        <div className="font-semibold text-[15px] tracking-tight leading-none text-white">
                            Catalyst
                        </div>
                        <div className="text-[10.5px] text-neutral-500 font-mono tracking-wider mt-1 uppercase">
                            useAI | showcase
                        </div>
                    </div>
                </div>
                ...
                <nav className="flex flex-col gap-1 flex-1 overflow-y-auto">
                    ...
                    >
                        ...
                        <span className="font-mono text-[11px] text-neutral-500 shrink-0 w-4.5 text-center">
                            00
                        </span>
                    ...
                    {chapters.map((c) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span
                                    className={`font-mono text-[11px] pt-[1px] shrink-0 w-4.5 text-center ${active ? "text-indigo-400" : "text-neutral-500"}`}
                                >
                                    {c.id}
                                </span>
                ...
                <div className="pt-3.5 border-t border-[var(--border)] mb-4">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        >
                            <span className="font-mono text-[11.5px] text-neutral-500 shrink-0 w-4.5 text-center">
                                🧪
                            </span>
                ...
                <div className="mt-auto pt-3.5 border-t border-[var(--border)] flex items-center justify-between">
                    <span className="text-[11.5px] text-neutral-500 font-semibold uppercase tracking-wider font-mono">
                        Appearance
                    </span>
                    <button
