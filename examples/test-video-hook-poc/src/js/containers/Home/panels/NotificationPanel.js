...
export function NotificationPanel() {
    ...
    return (
        <div className="col">
            ...
            {!isNative && (
                <DegradedBanner reason="Requires Service Worker + push, not available in WebView." />
            )}
            <HookStatusBar
            ...
            <div className={isNative ? "" : "degraded"}>
                <div className="card">
                    <div className="state-display" style={{ padding: "16px 12px" }}>
                        <span className="state-display__big state--undetermined">
                ...
                <div className="row" style={{ marginTop: 12 }}>
                    <button className="btn btn--primary grow" onClick={requestPermission}>
                        Request Permission
                    </button>
                </div>
