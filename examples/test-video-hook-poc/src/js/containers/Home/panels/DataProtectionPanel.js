...
export function DataProtectionPanel() {
    ...
    const { screenSecure, setScreenSecure, clearWebData, webFallbackActive, error } = useDataProtection({
    ...
    return (
        <div className="col">
            ...
            />
            <HookStatusBar
                state={screenSecure ? "active" : "idle"}
                label={screenSecure ? "Protection enabled" : "Protection disabled"}
            ...
            <div className="card">
                <div className="card__row">
                    ...
                    <span className={`pill ${screenSecure ? "pill--green" : ""}`}>
                        {screenSecure ? "On" : "Off"}
                    </span>
                </div>
            </div>
            ...
            <div className="row">
                <button
                    ...
                    disabled={screenSecure}
                    onClick={() => setScreenSecure(true)}
                >
                    Enable
                </button>
                <button className="btn grow" disabled={!screenSecure} onClick={() => setScreenSecure(false)}>
                    Disable
                </button>
            </div>
            ...
            {confirming && (
                <div className="card" style={{ borderColor: "var(--accent-red)" }}>
                    <div className="card__label" style={{ color: "var(--accent-red)" }}>
                        Confirm clear
                    </div>
                    <div className="row">
