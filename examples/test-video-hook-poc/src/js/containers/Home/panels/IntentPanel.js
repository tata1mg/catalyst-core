...
export function IntentPanel() {
    ...
    return (
        <div className="col">
            ...
            <HookStatusBar
                state={isNative ? "active" : "error"}
                label={isNative ? "Native active" : "Web disabled"}
                source="native"
            />
            ...
            <div className="degraded col">
                ...
                <div className="card">
                    ...
                    {resolved ? (
                        ...
                        >
                            Pick a file or enter input above
                        </div>
                    )}
                </div>

                <button className="btn btn--primary btn--block btn--lg" onClick={fire} disabled={!resolved}>
                    ...
                    {last ? (
                        <React.Fragment>
                            ...
                            <div className="card__row">
                                ...
                                <span className="card__val card__val--mono" style={{ maxWidth: "60%" }}>
                                    {last.action}
                                </span>
                            </div>
                            {last.type && (
                            ...
                            <div className="card__row">
                                ...
                                <span className="card__val card__val--mono">
                                    {last.ts.toLocaleTimeString()}
                                </span>
                            </div>
                        </React.Fragment>
                    ) : (
