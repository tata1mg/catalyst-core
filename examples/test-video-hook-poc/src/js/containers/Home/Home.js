            ...
            return (
                <div style={{ padding: 20, color: "var(--accent-red)" }}>
                    ...
                    <p style={{ marginBottom: 16, opacity: 0.8 }}>
                        {this.state.error?.message || "An unexpected error occurred in this hook."}
                    </p>
...
function Home() {
    ...
    const { top, right, bottom, left, isNative, webFallbackActive } = useSafeArea({
        webFallback: fallbacks.safe,
    })
                ...
                <main className="content">
                    <LocalErrorBoundary activeTab={active}>
                        <div
                            ...
                            style={{ viewTransitionName: "panel" }}
                        >
                            <Outlet
                                context={{
                                    fallbacks,
                    ...
                    <div className="col" style={{ gap: 16, marginTop: 8 }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 6 }}>
                                {["auto", "left", "right", "up", "down"].map((dir) => (
                                    <button
                                        ...
                                        onClick={() =>
                                            setTransitionOpts((prev) => ({ ...prev, direction: dir }))
                                        }
                                    >
                                        {dir}
                                    </button>
                        ...
                        <div className="card">
                            <div className="spread" style={{ marginBottom: 8 }}>
                                ...
                                <span className="kbd" style={{ fontSize: 13, fontWeight: "bold" }}>
                                    {transitionOpts.duration} ms
                                </span>
                            </div>
                            <input
                                type="range"
                            ...
                            <div
                                className="spread"
                                style={{ marginTop: 6, fontSize: 10, color: "var(--text-secondary)" }}
                            >
