...
| `WEBVIEW_CONFIG.ios.cachePattern` | No | Glob-style URL pattern(s) (string or array) the native WebView cache should match; defaults to no patterns (caching disabled) when unset |
