...
Use [Performance Profiling](/content/Core%20Concepts/performance-profiling) for the Android Chrome DevTools workflow, iOS trace export, captured signals, and the `window.CatalystPerf` API.
