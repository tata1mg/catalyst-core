 ...
 * structure and class names so the original index.module.css applies verbatim.
 */
            ...
            <div className={styles.heroContent}>
                <div className={styles.heroText}>
                    ...
                    <h1 className={styles.heroTitle}>
                        ...
                        <br />
                        <span className={styles.heroHighlight}>Web, iOS, and Android</span>
                    </h1>
                    <p className={styles.heroSubtitle}>
                        Build cross-platform applications with native device capabilities,
                        server-side rendering, and blazing-fast performance from a single
                        codebase.
                    </p>
                    ...
                    <div className={styles.terminalWindow}>
                        ...
                        <div className={styles.terminalBody}>
                            <div className={styles.terminalLine}>
                                ...
                                <span className={styles.terminalCommand}>npm run start</span>
                                <span className={styles.terminalLabel}>Web</span>
                            </div>
                            <div className={styles.terminalLine}>
                                <span className={styles.terminalPrompt}>$</span>
                                ...
                                <span className={styles.terminalLabel}>Android</span>
                            </div>
                            <div className={styles.terminalLine}>
                                <span className={styles.terminalPrompt}>$</span>
                                <span className={styles.terminalCommand}>
                                ...
                                <span className={styles.terminalLabel}>iOS</span>
                            </div>
...
function UniversalSection() {
    return (
        <section className={styles.universalSection}>
            <div className="container">
                <h2 className={styles.sectionTitle}>One Codebase. Every Platform.</h2>
                <p className={styles.sectionSubtitle}>
                    Build and scale with one shared architecture across web and native
                    touchpoints. Catalyst helps teams ship faster while keeping platform
                    behavior consistent, maintainable, and production-ready.
                </p>
                <div className={styles.platformGrid}>
                    <div className={styles.platformCard}>
                        <div className={styles.platformIcon}>Web</div>
                        <p>
                            Server-side rendering, code splitting, and SEO readiness for
                    ...
                    <div className={styles.platformCard}>
                        ...
                        <p>
                            Native APIs, notifications, camera access, and device capabilities
                    ...
                    <div className={styles.platformCard}>
                        ...
                        <p>
                            Flexible native integrations with camera, storage, and
            ...
            <div className="container">
                <div className={styles.footerContent}>
                    ...
                    <div className={styles.footerLinks}>
                        ...
                        <div className={styles.footerLinkColumn}>
                            <h4>Community</h4>
                            <a href="https://github.com/tata1mg/catalyst-core" target="_blank" rel="noreferrer">
                                GitHub
                            </a>
                            <a href="https://discord.gg/GTzYzP8X6s" target="_blank" rel="noreferrer">
                                Discord
                            </a>
                            <a
                            ...
                            <a href="mailto:catalyst-core@1mg.com">Contact</a>
                        </div>
                    </div>
                </div>
