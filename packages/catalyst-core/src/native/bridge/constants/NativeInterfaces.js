...
export const NATIVE_COMMANDS = {
    ...
    // Biometric commands
    AUTHENTICATE_BIOMETRIC: "authenticateBiometric",
    IS_BIOMETRIC_AVAILABLE: "isBiometricAvailable",
    SET_BIOMETRIC_CREDENTIAL: "setBiometricCredential",
    GET_BIOMETRIC_CREDENTIAL: "getBiometricCredential",
    DELETE_BIOMETRIC_CREDENTIAL: "deleteBiometricCredential",
...
export const NATIVE_CALLBACKS = {
    ...
    // Biometric callbacks
    ON_BIOMETRIC_AUTH_SUCCESS: "ON_BIOMETRIC_AUTH_SUCCESS",
    ON_BIOMETRIC_AUTH_ERROR: "ON_BIOMETRIC_AUTH_ERROR",
    ON_BIOMETRIC_AUTH_CANCELLED: "ON_BIOMETRIC_AUTH_CANCELLED",
    ON_BIOMETRIC_AVAILABILITY: "ON_BIOMETRIC_AVAILABILITY",
    ON_BIOMETRIC_CREDENTIAL_SET: "ON_BIOMETRIC_CREDENTIAL_SET",
    ON_BIOMETRIC_CREDENTIAL_GET: "ON_BIOMETRIC_CREDENTIAL_GET",
    ON_BIOMETRIC_CREDENTIAL_DELETED: "ON_BIOMETRIC_CREDENTIAL_DELETED",
    ON_BIOMETRIC_CREDENTIAL_ERROR: "ON_BIOMETRIC_CREDENTIAL_ERROR",
...
export const INTERFACE_CATEGORIES = {
    ...
    BIOMETRIC: {
        commands: [
            NATIVE_COMMANDS.AUTHENTICATE_BIOMETRIC,
            NATIVE_COMMANDS.IS_BIOMETRIC_AVAILABLE,
            NATIVE_COMMANDS.SET_BIOMETRIC_CREDENTIAL,
            NATIVE_COMMANDS.GET_BIOMETRIC_CREDENTIAL,
            NATIVE_COMMANDS.DELETE_BIOMETRIC_CREDENTIAL,
        ],
        callbacks: [
            NATIVE_CALLBACKS.ON_BIOMETRIC_AUTH_SUCCESS,
            NATIVE_CALLBACKS.ON_BIOMETRIC_AUTH_ERROR,
            NATIVE_CALLBACKS.ON_BIOMETRIC_AUTH_CANCELLED,
            NATIVE_CALLBACKS.ON_BIOMETRIC_AVAILABILITY,
            NATIVE_CALLBACKS.ON_BIOMETRIC_CREDENTIAL_SET,
            NATIVE_CALLBACKS.ON_BIOMETRIC_CREDENTIAL_GET,
            NATIVE_CALLBACKS.ON_BIOMETRIC_CREDENTIAL_DELETED,
            NATIVE_CALLBACKS.ON_BIOMETRIC_CREDENTIAL_ERROR,
        ],
    },
    NETWORK: {
...
// Biometry types reported by isBiometricAvailable
...
// Biometric error codes (kept stable across platforms)
export const BIOMETRIC_ERROR_CODE = {
    ...
    INVALID_PARAMS: "BIOMETRIC_INVALID_PARAMS",
    KEYCHAIN_ERROR: "BIOMETRIC_KEYCHAIN_ERROR",
    NOT_FOUND: "BIOMETRIC_CREDENTIAL_NOT_FOUND",
    NOT_IMPLEMENTED: "BIOMETRIC_NOT_IMPLEMENTED",
}
