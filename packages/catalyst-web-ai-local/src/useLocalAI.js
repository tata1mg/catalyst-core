...
export function useLocalAI({
    ...
    const generate = useCallback(
        ({ messages, genConfig: callGenConfig = {}, model: callModel }) => {
            ...
            if (!resolvedModel) {
                setError(new Error("[@catalyst/web-ai-local] no model specified — pass model prop or per-call model"))
                return
            }
            ...
            worker.onmessage = (e) => {
                ...
                switch (msg.type) {
                    ...
                    case "done":
                        ...
                        break
                    case "error":
                        console.error("[@catalyst/web-ai-local] worker error:", msg.message)
            ...
            worker.onerror = (e) => {
                console.error("[@catalyst/web-ai-local] worker uncaught error:", e)
