...
import { chatReducer, createInitialChatState, CHAT_ACTIONS, createMessage } from "../../core/state-manager.js"
        ...
        async (content, options = {}) => {
            ...
            try {
                ...
                const requestBody = {
                    ...
                    stream: true, // Enable streaming for dialogue
                    ...customBody,
                    ...options,
                }
                ...
                console.log("📥 [useDialogue] Response received, starting stream processing")
