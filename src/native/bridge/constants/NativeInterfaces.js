...
export const INTERFACE_CATEGORIES = {
    CAMERA: {
        commands: [
            NATIVE_COMMANDS.OPEN_CAMERA,
            NATIVE_COMMANDS.REQUEST_CAMERA_PERMISSION,
        ],
        callbacks: [
    ...
    FILE: {
        commands: [
            NATIVE_COMMANDS.PICK_FILE,
            NATIVE_COMMANDS.OPEN_FILE_WITH_INTENT,
        ],
        callbacks: [
    ...
    HAPTIC: {
        commands: [
            NATIVE_COMMANDS.REQUEST_HAPTIC_FEEDBACK,
        ],
        callbacks: [
            NATIVE_CALLBACKS.HAPTIC_FEEDBACK,
        ]
    }
};
