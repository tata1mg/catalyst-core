const Interfaces = ["CAMERA_PERMISSION_STATUS", "ON_CAMERA_CAPTURE", "ON_CAMERA_ERROR", "HAPTIC_FEEDBACK", "ON_INTENT_SUCCESS", "ON_INTENT_ERROR", "ON_INTENT_CANCELLED" , "ON_FILE_PICKED", "ON_FILE_PICK_ERROR","ON_FILE_PICK_CANCELLED"]
